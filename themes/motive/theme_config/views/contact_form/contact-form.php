<div class="tt-form-template contact-form-wrapper<?php echo $location == 'contact_footer'? '-footer' : ''?>" >
				...
				foreach($rows as $row) : ?> 
					<div class="row form-row">
						...
						<?php foreach( $row['columns'] as $column ) : ?> 
							<div class="col-md-<?php echo $column['size']?> col-xs-12 column"><!-- Start Column -->
